...
# 1. FIX MODELO: Restaurar el campo 'anio' en SQLAlchemy
w("backend/app/models/proyecto.py", [
...
# 2. FIX ROUTER: Detectar imágenes y convertirlas a Base64
w("backend/app/routers/projects.py", [
    ...
    "    data = payload.model_dump(exclude={'nombre_slug'})",
    "    obj = Proyecto(**data, nombre_slug=slug)",
    "    db.add(obj)",
    "    await db.commit()",
    ...
    "    if not fp.is_file(): return {'content': 'Archivo no existe.'}",
    "    ext = fp.suffix.lower()",
    "    if ext in ['.png', '.jpg', '.jpeg', '.gif', '.webp']:",
    "        with open(fp, 'rb') as f:",
    "            b64 = base64.b64encode(f.read()).decode('utf-8')",
    "            return {'content': f'data:image/{ext[1:]};base64,{b64}', 'is_image': True}",
    "    with open(fp, 'r', encoding='utf-8', errors='replace') as f: return {'content': f.read(), 'is_image': False}",
...
# 3. FIX FRONTEND: Evaluar bandera 'is_image' en el visualizador
